  ...
  return knex('blogpost').del()
    .then(function () {
      ...
      return knex('blogpost').insert([
        ...
        {author_id: 2, title: 'title2', body: 'This is where the body of the blogpost will go.', image: 'http://player.hu/uploads/2015/02/b6b65261ba36b20801c6196849ac8baa.jpg'},
